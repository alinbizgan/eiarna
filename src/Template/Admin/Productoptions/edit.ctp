<h2>Modificare Optiune de Produs</h2>
...
<div class="row">
    <div class="col-sm-5">
        ...
        <br />
        <?php echo $this->Form->input('name', ['class' => 'form-control', 'label' => 'Nume optiune de produs']); ?>
        <br />
        <?php echo $this->Form->input('price', ['class' => 'form-control', 'label' => 'Pret optiune de produs']); ?>
        <br />
